    ...
    <div class="max-w-md w-full space-y-8">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
          <router-link class="font-medium text-indigo-600 hover:text-indigo-500" to="/login">you already have an account</router-link>
        </p>
      </div>
      <form class="mt-8 space-y-6" @submit.prevent="signUp">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            ...
            <input id="full-name" v-model="form.fields.name" type="text" autocomplete="full-name" required="" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Full name" />
          </div>
          <div>
          ...
          <div>
            ...
            <input id="password-confirmation" v-model="form.fields.passwordConfirmation" type="password" autocomplete="current-password" required="" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Password confirmation" />
          </div>
        </div>
        <div>
